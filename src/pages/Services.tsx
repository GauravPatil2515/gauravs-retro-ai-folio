  ...
  return (
    <div className="min-h-screen bg-background py-12 md:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-16">
        <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-[#1A1A1A] mb-4 md:mb-6 text-center animate-fade-in-up hover:text-[#CD7F5E] transition-colors duration-300 cursor-default">
          What I Do
        </h1>
        ...
        <div className="max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
          <Card className="bg-gradient-to-br from-gray-50 to-white p-8 md:p-12 rounded-3xl shadow-xl border-2 border-gray-100 hover:shadow-2xl transition-all duration-500 group relative overflow-hidden">
